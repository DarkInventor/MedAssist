...
// Enhanced Login Screen Component with Firebase Auth
...
export function PhysicianAssistant() {
  ...
  const handleExportChat = () => {
    const exportData = {
      consultation: {
        ...
        physician: userProfile?.name || 'Unknown',
        specialty: userProfile?.specialty || 'General Practitioner',
        messages: messages,
  ...
  // Convert Firebase user profile to PhysicianProfile format
  const physician: PhysicianProfile = userProfile ? {
    id: userProfile.uid,
    name: userProfile.name,
    specialty: userProfile.specialty,
    institution: userProfile.institution,
    licenseNumber: userProfile.licenseNumber,
    preferences: userProfile.preferences || mockPhysician.preferences
  } : mockPhysician;
